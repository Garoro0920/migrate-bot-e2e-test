...
// It won't be called on the client-side, so you can even do
// direct database queries.
export default async function StaticPropsDetail({ params }: Props) {
  try {
    const { id } = params;
    ...
    // By returning JSX with `item`, the component receives it at build time
    return (
      <Layout
